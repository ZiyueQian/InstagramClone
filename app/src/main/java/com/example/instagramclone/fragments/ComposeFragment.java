...
//moving from MainActivity to Fragment - need to call getContext() for a lot of methods in order to work
...
public class ComposeFragment extends Fragment {
    ...
    //helper to get the Uri (string to identify the image file resource)
    ...
    private void savePost(String description, ParseUser currentUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                ivPostImage.setImageResource(0); //empty
